...
data ExternalDecl ζ = ExternalDecl
  { extName :: Name ζ,
    extType :: Typer ζ,
    extStr :: Text,
    extExt :: !(XExternal ζ)
...
data ImportDecl ζ = ImportDecl
  { impModule :: [Name ζ],
    impMode :: Either (Name ζ) [Name ζ]
  }

data Program ζ = Program
  { progExternal :: [ExternalDecl ζ],
    progLet :: [LetDecl ζ],
    progType :: [TypeDecl ζ],
